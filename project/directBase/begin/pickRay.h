...
public:
	...
	static bool chkPick(ray* in_ray, const D3DXVECTOR3 & position, float speed, boundingBox* bBox);
	static bool chkPick(ray* in_ray, const D3DXVECTOR3 & position, float speed, boundingSphere * bSphere);
