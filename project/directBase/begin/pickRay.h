...
public:
	...
	static bool isLine2Box(ray* in_ray, float speed, boundingBox bBox);
	static bool isLine2Sphere(ray* in_ray, D3DXVECTOR3 * outIntersection, float speed, const boundingSphere & bSphere);
