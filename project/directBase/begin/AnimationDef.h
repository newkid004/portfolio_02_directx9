...
{
	AWEAPON_RIFLE			= 0x1 * (int)aniDefine::SHIFTBIT::WEAPON,
	AWEAPON_PUMPSHOTGUN		= 0x2 * (int)aniDefine::SHIFTBIT::WEAPON,
	AWEAPON_FIRSTAIDKIT		= 0x3 * (int)aniDefine::SHIFTBIT::WEAPON,
...
enum FEMALE_IDLE
{
	FEMALE_IDLE_NONE		= 0x0 * (int)aniDefine::SHIFTBIT::SUB,
	FEMALE_IDLE_ALERT		= 0x1 * (int)aniDefine::SHIFTBIT::SUB,
	FEMALE_IDLE_NEUTRAL1	= 0x2 * (int)aniDefine::SHIFTBIT::SUB,
	FEMALE_IDLE_NEUTRAL2	= 0x3 * (int)aniDefine::SHIFTBIT::SUB,
	FEMALE_IDLE_NEUTRAL3	= 0x4 * (int)aniDefine::SHIFTBIT::SUB
};
